...
Tyk Gateway exposes a helpful set of *span attributes* and *resource attributes* with the generated spans. These attributes helpful to understand your API requests better. To get a clearer picture, you need to look at what specific actions are happening and the context in which they occur. This is span and resource attributes play a significant role.

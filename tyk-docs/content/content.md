...
{{< badge read="10 mins" imageStyle="object-fit:contain" href="tyk-self-managed/install" image="/img/logos/tyk-logo-selfmanaged.svg" imageAlt="Tyk Self Managed">}}
Includes Tyk API Gateway, Tyk Dashboard, Tyk Portal, Tyk UDG
{{< /badge >}}

{{< badge read="15 mins" imageStyle="object-fit:contain" href="tyk-cloud/" image="/img/logos/tyk-logo-cloud.svg" imageAlt="Tyk Cloud">}}
Includes Tyk API Gateway, Tyk Dashboard, Tyk Portal, Tyk UDG
{{< /badge >}}

{{< badge read="7 mins" imageStyle="object-fit:contain" href="apim/open-source/" image="/img/logos/tyk-logo-opensource.svg" imageAlt="Tyk OSS Gateway">}}
